...
function ConfirmDelete(props:{
  ...
  return (
    <div className="w-[87%] bg-white shadow-delete p-8 flex flex-col rounded-lg dark:bg-[#1E2139]">
      <h1 className="spartan text-[20px] text-[#0C0E16] font-bold dark:text-white">Confirm Deletion</h1>
      ...
      <div className="flex justify-end gap-4 mt-6">
          <button onClick={cancel} className="spartan text-[15px] font-bold text-[#7E88C3] dark:bg-[#252945] w-[90px] rounded-3xl dark:text-white">Cancel</button>
